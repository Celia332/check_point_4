 ...
 */
final class Version20220202150122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sneakers ADD title VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sneakers DROP title, CHANGE text text LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
